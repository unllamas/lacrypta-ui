...
```css showLineNumbers copy filename="fonts/main.css"
@font-face {
  font-family: 'Blatant';
...
```js showLineNumbers copy {4} filename="app/layout.tsx"
...
```json {5-8} showLineNumbers copy filename="config/theme.json"
{
  "colors": {
    ...
  },
